...
function OneTimeInvestmentCalculator() {
  ...
  const calculateReturns = useCallback((isButtonClick = false) => {
    ...
    // One-time investment formula: P * (1 + r)^n
  ...
  }, [state.isFirstCalculation, calculateReturns]);
          ...
          <div className="content-left">
            <div className="calculator-box">
              ...
              <p className="calculator-intro">
                Calculate returns on your one-time investment over a specific time period
              </p>
              ...
              <div className="button-container">
                <button className="calculate-button" onClick={() => calculateReturns(true)}>
                  Calculate
                </button>
